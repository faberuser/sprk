...
Modules are grouped by feature. `mod.rs` declares the groups; `src/main.rs` registers HTTP routes, including the routers provided by `battle`, `community`, and `extensions`.
